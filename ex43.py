...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print "In a panic you throw the bomb at the grop of Gothons"
            ...
            print "Now that the bomb is placed you run to escape pod to"
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print "implodes at the hull ruptures, crushing your body"
